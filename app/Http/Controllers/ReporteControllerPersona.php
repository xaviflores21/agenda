...
class ReporteControllerPersona extends Controller
{
    /**
    ...
    if (!empty($sort)) {
        ...
        // Get the results
        $reportePersona = $query->get();
    
        // Return the data to the view
        return view('eventos.reportePersona', compact('reportePersona','sort','sortDirection'));
    }
