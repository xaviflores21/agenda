...
class reporteHorarioController extends Controller
{
    /**
    ...
    if (!empty($sort)) {
        ...
        // Get the results
        $reporteHorario = $query->get();
    
        // Return the data to the view
        return view('eventos.reporteHorario', compact('reporteHorario','sort','sortDirection'));
    }
